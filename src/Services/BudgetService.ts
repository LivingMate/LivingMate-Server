...
async function findCategIdByName(categoryName:string) {
  try {
...
const createBudget = async (
  ...
  try {
    ...
    const resUserColor = await findUserColorByUserId(userId);
    ...
    const resUserName = await getUserNameByUserId(userId);
